...
def data_stats_visualizer(input_file='tmpcqoaylac20170407.csv', output_path = 'tmpcqoaylac20170407.csv_imgs'):
...
import shutil
def main(argv):
    print('data_stats_visualizer v0.1')    
    ...
    data_stats_visualizer(input_file = inputfile, output_path = outputfolder)
